...
from game import create_deck, select_dealer, deal_five_cards, deal_remaining_cards, get_valid_moves, determine_trick_winner
...
def start_game():
    ...
    game_state["seating_order"] = seating_order
    game_state["dealer"] = dealer
    game_state["dealer_index"] = dealer_index
    game_state["trump_selector"] = trump_selector
    game_state["first_leader"] = first_leader
    game_state["five_card_hands"] = five_card_hands
    game_state["remaining_deck"] = remaining_deck
...
def play_card_endpoint(player: str, rank: str, suit: str):
    ...
    players_already_played = [p for p, c in current_trick]
